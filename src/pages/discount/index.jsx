...
const Discount = () => {
  ...
  const fetchDiscounts = async (page = 1, keyword = "") => {
    try {
      setLoading(true);
      const url = `${hostUrl}coupons?discountType=Discount&page=${page}&limit=${pageSize}${
  ...
  useEffect(() => {
    fetchDiscounts(currentPage, searchText);
  }, []);
  ...
  const handlePageChange = (page) => {
    setCurrentPage(page);
    fetchDiscounts(page, searchText);
          ...
          <div className="col-12">
            <div className="lists-wrapper businesslist">
              <div className="list-filter d-flex justify-content-between align-items-center mb-3">
                <h5 className="mb-0 fw-semibold">Discounts List</h5>
                <input
                  className="lfs-input"
                  type="text"
